...
public class JMSManager implements MessageListener, ExceptionListener
{
	...
	/**
	 * Atributo tipo Topic que maneja la conexión al topic de dar todas las funciones 
	 */
	private Topic topic;
	...
	/**
	 * Método que retorna la respuesta a requerimiento de dar todas las funciones.
	 ...
	 * - Caso 1: a[0].equals(GET_ALL_FUNCTIONS_ASK): llega la petición del requerimiento dar todas las funciones por lo 
	 * que pide todos los videos a la clase principal y manda un mensaje con la respuesta 
	 * - Caso 2: a[0].equals(GET_ALL_FUNCTIONS_REPLY): llega la respuesta de la petición del requerimiento por lo tanto
